...
pub fn fibonacci_iteratif(n: u64) -> u64 {
    match (n) {
        ...
        _ => {
            ...
            // for i in range(1, n):
            for _i in 1..n
            // Avec un '_' en début du nom de variable: Pas explicitement utilisée
            {
                w = u + v;
                u = v;
                v = w;
...
pub fn resoud_tours_de_hanoi(n: u32) {
    ...
    println!(
        "Résolution du problème des tours de Hanoï avec {} élément(s).",
        n
    );
